(function ()
{
    ...
    /** @ngInject */
    function ToolbarController($rootScope, $q, $scope,  $state, $mdDialog,  $timeout, $mdSidenav, $translate, $mdToast, msNavigationService, AuthService)
    {
        var vm = this;
        ...
        vm.showDialog = function (ev) {
            $mdDialog.show({
                ...
                templateUrl: 'app/toolbar/layouts/vertical-navigation/changepassword.tpl.html',
    ...
    function DialogController($scope, $mdDialog, AuthService) {
        ...
        $scope.save = function () {
            AuthService.ChangePassword($scope.changePassword).then(function () {
                $mdDialog.hide();
            })
        };
    }
